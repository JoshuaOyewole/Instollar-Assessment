    ...
    <div className="h-screen overflow-y-scroll bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      <section className="relative overflow-hidden flex items-center">
        ...
        <div className="relative mx-auto flex justify-center px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center items-center mb-20 w-[95%] lg:w-4/5 mx-auto flex flex-col gap-y-6 lg:gap-y-10 !mt-32 !lg:mt-0 ">
            {/* Enhanced Badge */}
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold text-gray-900 !lg:mb-8 !lg:leading-[0.9] !tracking-tight">
              ...
              <span className="hidden lg:block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-pulse">
                Perfect Match?
              </span>
              <span className='lg:hidden block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-pulse'>for you</span>
            </h1>
            ...
            {!user && (
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6 ">
                <Link
                  href="/auth/register"
                  className="group relative bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white !px-8 !py-4 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-blue-500/25 hover:scale-110 transition-all duration-500 flex items-center overflow-hidden"
                >
